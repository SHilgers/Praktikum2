...
maximal konstruktive Interferenz tritt auf falls bei ganzen Vielfachen von $2\pi$
\begin{align*}
...
\begin{equation}
  ...
  \label{eqn:imaxmin}
\end{equation}
Falls die beiden Wellen senkrecht zueinander stehen, also $\Delta\phi=\frac{\pi}{2}$,
interferieren sie nicht, da der Inteferenzterm $I_{12}\propto \cos(\Delta\phi)$ verschwindet.\\
...
Durchläuft einer der beiden Strahlen ein Medium mit einem veränderten Brechungsindex
...
kommen, falls einer der Strahlen dieses Gas durchläuft.
