...
Im Folgenden wird der systematische Fehler der Leerlaufspannung $U_{0}$ berechnet,
...
\begin{figure}[H]
  ...
  \label{fig:plot5}
\end{figure}
\noindent Wie in \ref{fig:plot5} zu sehen liegen die Messwerte genau auf der
