...
\begin{figure}[H]
  ...
  \label{fig:gerade}
\end{figure}
Hieraus ergeben sich für die Steigung a und den y-Achsenabschnitt die Parameter
\begin{align*}
...
Mit den nun bereits vorhandenen Messwerten aus den Tabellen \ref{tab:tabe2}
