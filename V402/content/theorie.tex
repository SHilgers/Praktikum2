...
Fällt Licht auf eine Materieschicht, so wirkt ducht das elektrische Feld eine
periodische Kraft
\begin{equation}
...
\subsection{Fallunterscheidung $a_3$} %$\lambda >> \lambda_1$}
...
\subsection{Fallunterscheidung}% $\lambda=\lambda_1$}
