...
\subcaption{\small Linien ohne Aufspaltung}
\label{fig:rot1}
\end{subfigure}
\begin{subfigure}[c]{0.5\textwidth}
\includegraphics[width=0.8\textwidth]{Rot2.JPG}
\subcaption{\small Linien mit Aufspaltung}
\label{fig:rot2}
\end{subfigure}
...
\subcaption{\small $\sigma$-Linien mit Aufspaltung}
\label{fig:blau2}
\end{subfigure}
\begin{subfigure}[c]{0.5\textwidth}
\includegraphics[width=0.8\textwidth]{Blau3.JPG}
\subcaption{\small $\pi$-Linien mit Aufspaltung}
\label{fig:blau3}
\end{subfigure}
