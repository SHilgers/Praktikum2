...
wx=[121.7817, 244.6974, 344.2785, 411.1165, 443.965,
778.9045, 867.380, 964.079, 1085.837, 1112.076, 1408.013]
dx=[0.0003, 0.0008, 0.0012, 0.0012, 0.003, 0.0024,
0.003, 0.018, 0.010, 0.003, 0.003]
wq=[0.5368, 0.3549, 0.2416, 0.1949, 0.1827, 0.0987,
0.0857, 0.0809, 0.0768, 0.0745, 0.0550]
dq=[0.0105, 0.0090, 0.0048, 0.0106, 0.0089, 0.0032,
0.0063, 0.0036, 0.0046, 0.0032, 0.0027]

#for m in range (0,11):
#    x[m]=array(wx[m],dx[m])
#    y[m]=array(wy[m],dy[m])
params, cov = curve_fit(f, wx, wq ,p0=(1, 0.003 ,-2))
