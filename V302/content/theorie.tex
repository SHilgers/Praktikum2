...
\begin{figure}[H]
  \centering
  \includegraphics[width=8cm,height=6cm]{induktivitat.JPG}
...
In dieser Schaltung sollte die Induktivität $L_{2}$ möglichst geringe Verluste besitzen und der
...
Frequenz abgleichen lassen, in der Praxis gibt es jedoch eine Frequenzbereich in dem
...
warten muss bis sich eine stabile Brückenspannung einstellt.
...
Aus \ref{eqn:ubrücke} und \ref{zbrücke} erhält man, dass die Brückenspannung genau für
\begin{equation*}
  \omega_{0}=\frac{1}{RC}
  \label{eqn:omega}
\end{equation*}
...
Den Klirrfaktor erhält man, indem am Sinusgenerator die Sperrfrequenz $\omega_{0d}$
