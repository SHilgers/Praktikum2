...
\end{align*}
ergibt.
Hieraus ergibt sich durch Gleichung % \ref{eqn:}
\begin{align*}
  R= \SI{126.5(10)}{\ohm} \\
...
\noindent Theoretisch berechnet ergibt sich durch die Formel %\ref{eqn:}
ein Wert von
\begin{equation*}
...
Schaltkreises lässt sich durch die Gleichung %\ref{eqn:gute}
...
\begin{equation*}
  \nu_+ - \nu_- = \SI{8500}{\hertz}
\end{equation*}
ergibt. Theoretisch lässt sich durch Gleichung %\ref{eqn:}
...
ist, ablesen. \\
\noindent Die nach Gleichungen % \ref{eqn}
